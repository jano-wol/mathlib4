...
lemma sl2SubmoduleOfRoot_eq_sup (α : Weight K H L) (hα : α.IsNonZero) :
  ...
  · intro hx
    ...
    · exact Submodule.mem_sup_left (Submodule.mem_sup_left (Submodule.smul_mem _ _ heα))
    · exact Submodule.mem_sup_left (Submodule.mem_sup_right (Submodule.smul_mem _ _ hfα))
    · apply Submodule.mem_sup_right
      ...
      · have h_span : (LieAlgebra.corootSpace α.toLinear).toSubmodule =
        ...
        change c₃ • LieAlgebra.IsKilling.coroot α ∈
          (LieAlgebra.corootSpace α.toLinear).toSubmodule
        rw [h_span]
